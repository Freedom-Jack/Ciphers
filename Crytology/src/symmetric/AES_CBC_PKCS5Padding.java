...
public class AES_CBC_PKCS5Padding {
	...
	public static void main(String[] args) throws Exception {
		...
		aesPaddingDecrypt(key_temp, iv_temp, ct_temp);
	}
	 ...
	 * @throws Exception
	 */
	public static void aesPaddingDecrypt(String string_key, String string_iv, String string_ct) throws Exception {
		...
		byte[] pt = aes_cipher.doFinal(ct);

		// Output the plain text
		System.out.println("The plain text: >" + new String(pt) + "<");
	}
}
